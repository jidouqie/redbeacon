...
**③ 主动给「现在最该做什么」**（按现状排优先级，给 2~3 个**具体动作**，不是罗列全部能力）：

- 有待审 → 「先把飞书里那 {M} 篇审了，标通过我就发」
- 选题够、没积压 → 「写一篇？我列几条没写的选题你挑一条」→ 进下面「写文案 = 挑选题共创」
- 选题告急(<5) → 「选题快见底了，要不要开个选题规划会补一批」
- 啥都没积压 → 「直接写一篇最实在，我列选题你挑」
