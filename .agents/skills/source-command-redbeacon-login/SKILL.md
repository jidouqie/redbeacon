---
name: source-command-redbeacon-login
...
> - **小红书登录** = 每个小红书账号扫码挂登录态，管**发布**，是另一个 skill：`/source-command-redbeacon-xhslogin`。
>
...
- 还没建号 → `/source-command-redbeacon-accounts`
- 账号没登录小红书 → `/source-command-redbeacon-xhslogin`
- 账号没定位 → `/source-command-redbeacon-locate`
...
| 扫码登录**小红书** / 查登录态 / 重登 | `/source-command-redbeacon-xhslogin` |
| 配代理 | `/source-command-redbeacon-config` |
| 建号 / 改名 / 删号 | `/source-command-redbeacon-accounts` |
